...
class Servidor:
    def __init__(self) -> None:
        ...
        self.publicando = True  # Controle do broadcast
        self.executando = True  # Controle do servidor
    ...
    def aguardar_comandos(self):
        ...
        while self.executando:
            ...
            if op == "4":
                self.publicando = False  # Para o broadcast
    ...
    def menu(self):
            self.recebendo_dados = False 

            while True:
                """Executa uma ação do menu e volta automaticamente para o broadcast."""
